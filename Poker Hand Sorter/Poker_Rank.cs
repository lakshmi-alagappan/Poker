...
{
    public interface IPoker_Rank
    {
        Tuple<int, double> Score(int order);
    }

    public abstract class Poker_Rank : IPoker_Rank
    {
        ...
        public Poker_Rank(IEnumerable<string> cards)
        {
            this.cards = cards;
        }
    ...
    public class Four_Of_Kinds : Poker_Rank
    {
    ...
    public class Full_House : Poker_Rank
    {
    ...
    public class Straight : Poker_Rank
    {
    ...
    public class Three_Of_Kinds : Poker_Rank
    {
        ...
        protected override double Remainder
        {
            ...
            {
                return
                GetGroups(3).First().Key * Math.Pow(15, 3) +
                GetGroups(1).Select((c, idx) => c.Key * Math.Pow(15, idx)).Sum();
            }
        }
    }

    public class Two_Pairs : Poker_Rank
    {
    ...
    public class One_Pair : Poker_Rank
    {
    ...
    public class High_Card : Poker_Rank
    {
